...
ec2:
  subnet_id: subnet-xxxxx              # Optional: Custom subnet
  security_group_ids: [sg-xxxxx]        # Optional: Security groups
  associate_public_ip_address: true     # Optional: Public IP control
```
